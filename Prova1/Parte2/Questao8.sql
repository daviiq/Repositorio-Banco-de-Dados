...
-- Lista todos os álbuns com o nome do artista e da gravadora que pertencem -- 
SELECT AL.titulo, A.nomeArtista, G.nome
FROM ALBUM AL
INNER JOIN ARTISTA A
    ON A.idArtista = AL.idArtista
INNER JOIN GRAVADORA G
    ON G.idGravadora = AL.idGravadora;
